...
from audio_transcriber.utils import to_boolean, to_integer
from audio_transcriber.middlewares import (
    UserTokenMiddleware,
...
def audio_transcriber_mcp():
    ...
    parser = argparse.ArgumentParser(
        add_help=False, description="Audio Transcriber MCP - Run in stdio or http mode"
    )
    parser.add_argument(
        "-t",
        "--transport",
    ...
    parser.add_argument(
        ...
        help="Comma-separated list of required scopes (e.g., audiotranscriber.read,audiotranscriber.write).",
    )
    # OAuth Proxy params
    parser.add_argument(
...
def usage():
    print(
        f"Audio Transcriber ({__version__}): Audio Transcriber MCP - Run in stdio or http mode\n\n"
        "Usage:\n"
        ...
        "--required-scopes                  [ Comma-separated list of required scopes (e.g., audiotranscriber.read,audiotranscriber.write). ]\n"
