...
from audio_transcriber.utils import to_boolean, to_integer, get_mcp_config_path, get_skills_path, load_skills_from_directory
...
AGENT_DESCRIPTION = (
    "An intelligent agent for audio transcription and processing."
)
...
def create_agent(
    ...
    return Agent(
        ...
        system_prompt=(
            ...
            "2. Use the available skills and tools to process the audio.\n"
