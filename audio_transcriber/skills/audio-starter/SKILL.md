...
name: audio-starter
description: >-
  Audio Transcriber API + MCP Server + A2A Server Use when working with Audio Transcriber via this package's MCP
...
license: MIT
tags: [audio-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Audio Transcriber Starter Skill

Starter skill for the **Audio Transcriber** package. Use the `mcp-client` universal skill
