...
> **Install the connector-focused `[mcp]` extra.** Examples use `audio-transcriber[mcp]` to add
...
[Deployment guide](https://knuckles-team.github.io/audio-transcriber/deployment/) carries
