...
# Paths
ROOT_DIR = "/home/apps/workspace/agent-packages/agents/audio-transcriber"
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in audio-transcriber
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in audio-transcriber but are NOT registered "
